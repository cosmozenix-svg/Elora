    ...
    <div className="flex-1 flex flex-col justify-center px-4 py-6 w-full max-w-sm mx-auto my-auto relative">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200/80 dark:border-slate-800 transition-colors">
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full mt-2 py-3 px-4 rounded-xl shadow-sm text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 active:scale-[0.98] transition-all flex justify-center items-center cursor-pointer"
          >
            Sign in
          </button>
        </form>
